...
if (message.content.toLowerCase().startsWith(prefix + `help`)) {
  ...
  .setTitle(`:mailbox_with_mail: Savage Help`)
  .setColor(0xCF40FA)
  .setDescription(`Hello! I'm Savage Bot, the Discord bot for super cool support ticket stuff and more! Here are my commands:`)
